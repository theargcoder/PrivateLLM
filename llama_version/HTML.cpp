...
<style>
    ...
    .ds-input {
        ...
        transition:
            background-color var(--ds-transition-duration) var(--ds-ease-in-out),
    ...
    .ds-input.ds-input--none:focus-within {
        background-color: var(--ds-input-focus-color,
    ...
    .ds-icon-button:hover:before {
        background-color: var(--ds-icon-button-hover-color,
    ...
    .ds-modal-content {
        font-size: var(--ds-font-size-m);
        line-height: var(--ds-line-height-m);
        color: var(--ds-modal-content-text-color,
                rgb(var(--ds-rgb-label-1)));
        box-sizing: border-box;
        background-color: var(--ds-modal-content-color,
    ...
    .ds-skeleton {
        ...
        -ms-user-select: none;
        user-select: none;
        animation: 2s cubic-bezier(0.36, 0, 0.64, 1) infinite ds-skeleton-loading;
    }
    ...
    .ds-fade-in-zoom-in-expand-enter-active {
        opacity: 1;
        transition:
            max-height var(--ds-ease-in) var(--ds-transition-duration-fast),
            opacity var(--ds-ease-in) var(--ds-transition-duration-fast),
            transform var(--ds-ease-in) var(--ds-transition-duration-fast);
        transform: scale(1);
    }
    ...
    .ds-fade-in-zoom-in-expand-exit-active {
        opacity: 0;
        transition:
            max-height var(--ds-ease-out) var(--ds-transition-duration-fast),
            opacity var(--ds-ease-out) var(--ds-transition-duration-fast),
            transform var(--ds-ease-out) var(--ds-transition-duration-fast);
        transform: scale(0.8);
    }
    ...
    .ds-toast {
        --ds-toast-color: var(--ds-toast-custom-color,
                rgb(var(--ds-rgb-elevated)));
        --ds-toast-text-color: var(--ds-toast-custom-text-color,
                rgb(var(--ds-rgb-label-1)));
        --ds-toast-border-radius: 12px;
        --ds-toast-font-size: var(--ds-toast-custom-font-size,
                var(--ds-font-size-m));
    ...
    .ds-toast {
        ...
        box-shadow: var(--ds-toast-custom-box-shadow,
    ...
    .ds-toast .ds-toast__close:hover {
        background-color: var(--ds-toast-custom-close-hover-color,
                #f5f5f5);
    }
    ...
    .ds-button.ds-button--filled.ds-button--secondary {
        background-color: var(--ds-secondary-button-color,
                var(--ds-button-color, rgb(var(--ds-rgb-input))));
    }

    .ds-button.ds-button--filled.ds-button--secondary:hover {
        background-color: var(--ds-secondary-button-hover-color,
                rgb(var(--ds-rgb-hover)));
    }
    ...
    .ds-button.ds-button--bordered:hover {
        background-color: var(--ds-button-bordered-hover-color,
                rgb(var(--ds-rgb-hover)));
    }
    ...
    .ds-radio-button-group.ds-radio-button-group--bordered3 {
        ...
        --radio-button-group-button-box-shadow-focus: inset 0 0 0 1px rgb(var(--ds-rgb-separator-strong));
        --radio-button-group-button-color-active: rgba(var(--ds-rgb-primary) / 0.16);
        --radio-button-group-button-text-color-active: rgb(var(--ds-rgb-primary));
        --radio-button-group-button-outline-box-shadow-focus: 0 0 0 2px rgb(var(--ds-rgb-primary));
    }
    ...
    .ds-textarea.ds-textarea--focused {
        background-color: var(--ds-textarea-focus-color,
                rgb(var(--ds-rgb-input-focus)));
        box-shadow: inset 0 0 0 2px var(--ds-textarea-focus-border-color,
    ...
    .ds-dropdown-menu-option.ds-dropdown-menu-option--error {
        ...
        --ds-dropdown-menu-option-color-hover: var(--ds-dropdown-menu-option-error-color-hover,
    ...
    .ds-segmented {
        background-color: var(--ds-segmented-color,
    ...
    .ds-segmented-button.ds-segmented-button--selected {
        font-weight: var(--ds-font-weight-strong);
        background-color: var(--ds-segmented-selected-color,
    ...
    .dc04ec1d {
        ...
        transition:
            left var(--ds-transition-duration-fast) var(--ds-ease-in-out),
            max-width var(--ds-transition-duration-fast) var(--ds-ease-in-out);
        flex-shrink: 0;
        position: fixed;
        top: 0;
        bottom: 0;
    ...
    [data-ds-dark-theme] .b480065b {
        background: linear-gradient(rgba(41, 42, 45, 0.8) 0%,
                rgba(41, 42, 45, 0) 100%);
    }
    ...
    [data-ds-dark-theme] {
        --ds-toast-custom-box-shadow: 0px 4px 10.2px 0px rgba(0, 0, 0, 0.25);
...
<body class="apple en_US dark" data-ds-dark-theme="dark" style="--app-height: 878px">
    <div id="root">
        <div class="cb86951c">
            <div class="c3ecdb44">
                <div class="f2eea526">
                                        ...
                                        <div class="aaff8b8f">
                                            <div class="cefa5c26">
                                                <div class="dd442025 b699646e">
                                                    <div class="fad49dec">
                                                        <textarea id="chat-input" class="c92459f0" placeholder="Message DeepSeek" rows="2"></textarea>
                                                        <div class="b13855df"></div>
                                                    </div>
                                                    <div class="ec4f5d61">
                                                        <div role="button" class="ds-button ds-button--primary ds-button--filled ds-button--rect ds-button--m d9f56c96" style="
                                                ...
                                                " tabindex="0">
                                                      ...
                                                      ">
                                                         ...
                                                         ">
                                                            ...
                                                            <span class="ad0c98fd">DeepThink (R1)</span>
                                                        </div>
                                                        <div role="button" class="ds-button ds-button--primary ds-button--filled ds-button--rect ds-button--m d9f56c96" style="
                                                   --ds-button-color: transparent;
                                                ...
                                                " tabindex="0">
                                                      ...
                                                      ">
                                                         ...
                                                         ">
                                                            ...
                                                            <span class="ad0c98fd">Search</span>
                                                        </div>
                                                        <div class="bf38813a">
                                                            <div class="f02f0e25">
                                                                <div class="ds-icon" style="
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            // Select the parent container that will hold all your divs
            const containerWrapper = document.body; // or use a more specific parent if needed

            // Listen for clicks anywhere in the document
            containerWrapper.addEventListener("click", function(event) {
                // Check if the clicked element is a trigger (the .a6d716f5.db5991dd)
                const trigger = event.target.closest(".a6d716f5.db5991dd");

                if (trigger) {
                    // Find the parent container (the div with class .edb250b1)
                    const container = trigger.closest(".edb250b1");

                    // Find the content to toggle inside that container
                    const content = container.querySelector(".e1675d8b");
