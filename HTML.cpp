...
<html lang="en">
      ...
      <head>
         ...
         <script>
            document.addEventListener('DOMContentLoaded', function () {
               document.body.addEventListener('click', function (event) {
                  let target = event.target.closest("div[role='button']");
                  if (target) {
                     let message = 'Button clicked: ' + target.innerText;

                     // Notify C++ wxWebView
                     if (window.chrome && window.chrome.webview) {
                        window.chrome.webview.postMessage(message);
                     } else if (window.external && window.external.invoke) {
                        window.external.invoke(message); // For wxWebView (non-WebView2)
                     }
                  }
               });
            });
         ...
         <style>
            ...
            .ds-fade-in-zoom-in-active {
               opacity: 1;
               transition:
                  opacity var(--ds-ease-in) var(--ds-transition-duration-fast),
            ...
            .ds-fade-in-zoom-in-exit-active {
               opacity: 0;
               transition:
                  opacity var(--ds-ease-out) var(--ds-transition-duration-fast),
                  transform var(--ds-ease-out)
            ...
            .ds-input {
               ...
               transition:
                  background-color var(--ds-transition-duration)
                     var(--ds-ease-in-out),
            ...
            .ds-input.ds-input--none:focus-within {
               background-color: var(
                  --ds-input-focus-color,
                  --ds-input-color-focus
               );
               box-shadow: inset 0 0 0 2px
                  var(--ds-input-focus-border-color, rgb(var(--ds-rgb-primary)));
            }
            ...
            .ds-input.ds-input--bordered.ds-input--error {
               background-color: rgba(var(--ds-rgb-error) / 0.06);
               box-shadow: inset 0 0 0 2px
                  var(--ds-input-focus-border-color, rgb(var(--ds-rgb-error)));
            }
            ...
            .ds-icon-button:hover:before {
               background-color: var(
                  --ds-icon-button-hover-color,
                  rgb(var(--ds-rgb-hover))
               );
            }

            .ds-icon-button:before {
               transition: background-color var(--ds-transition-duration)
                  var(--ds-ease-in-out);
               content: '';
               background-color: rgba(var(--ds-rgba-transparent));
            ...
            .ds-icon-button:after {
               transition: box-shadow var(--ds-transition-duration)
                  var(--ds-ease-in-out);
               content: '';
            ...
            .ds-fade-in-active {
               opacity: 1;
               transition: opacity var(--ds-ease-in)
                  var(--ds-transition-duration-fast);
            }
            ...
            .ds-fade-in-exit-active {
               opacity: 0;
               transition: opacity var(--ds-ease-out)
                  var(--ds-transition-duration-fast);
            }
            ...
            .ds-modal-content {
               ...
               line-height: var(--ds-line-height-m);
               color: var(
                  --ds-modal-content-text-color,
                  rgb(var(--ds-rgb-label-1))
               );
               box-sizing: border-box;
               background-color: var(
                  --ds-modal-content-color,
                  rgb(var(--ds-rgb-elevated))
               );
               border-radius: 18px;
               outline: none;
               width: 525px;
            ...
            body.dark .ds-skeleton {
               --color-start: rgba(255, 255, 255, 0.12);
               --color-end: rgba(255, 255, 255, 0.18);
            }
            ...
            .ds-skeleton {
               ...
               max-width: 100%;
               transition:
                  --color-start 0.3s var(--ds-ease-in-out),
                  --color-end 0.3s var(--ds-ease-in-out),
                  background-color 0.3s var(--ds-ease-in-out);
               background-color: var(--color-start);
               -webkit-user-select: none;
               -moz-user-select: none;
               -ms-user-select: none;
               user-select: none;
               animation: 2s cubic-bezier(0.36, 0, 0.64, 1) infinite
                  ds-skeleton-loading;
            }
            ...
            .ds-toast {
               --ds-toast-color: var(
                  --ds-toast-custom-color,
                  rgb(var(--ds-rgb-elevated))
               );
               --ds-toast-text-color: var(
                  --ds-toast-custom-text-color,
                  rgb(var(--ds-rgb-label-1))
               );
               --ds-toast-border-radius: 12px;
               --ds-toast-font-size: var(
                  --ds-toast-custom-font-size,
                  var(--ds-font-size-m)
               );
            ...
            @supports (top: env(safe-area-inset-top)) {
               .ds-toast-container.ds-toast-container--top {
                  top: calc(
                     var(--ds-toast-top-distance) + env(safe-area-inset-top)
                  );
                  bottom: calc(
                     var(--ds-toast-top-distance) + env(safe-area-inset-bottom)
                  );
                  left: calc(
                     var(--ds-toast-top-distance) + env(safe-area-inset-left)
                  );
                  right: calc(
                     var(--ds-toast-top-distance) + env(safe-area-inset-right)
                  );
               }
            }
            ...
            .ds-toast {
               ...
               box-shadow: var(
                  --ds-toast-custom-box-shadow,
                  0px 4px 15px 0px rgba(191, 196, 213, 0.25)
               );
               align-items: center;
               display: flex;
            }
            ...
            .ds-toast .ds-toast__close:hover {
               background-color: var(
                  --ds-toast-custom-close-hover-color,
                  #f5f5f5
               );
            }
            ...
            .ds-button.ds-button--filled.ds-button--error:hover {
               --ds-button-color: rgb(
                  var(--ds-rgb-error-hover, var(--ds-rgb-error))
               );
            }

            .ds-button.ds-button--filled.ds-button--secondary {
               background-color: var(
                  --ds-secondary-button-color,
                  var(--ds-button-color, rgb(var(--ds-rgb-input)))
               );
            }

            .ds-button.ds-button--filled.ds-button--secondary:hover {
               background-color: var(
                  --ds-secondary-button-hover-color,
                  rgb(var(--ds-rgb-hover))
               );
            }
            ...
            .ds-button.ds-button--bordered:hover {
               background-color: var(
                  --ds-button-bordered-hover-color,
                  rgb(var(--ds-rgb-hover))
               );
            }
            ...
            .ds-banner {
               ...
               --ds-banner-close-icon-color: rgb(
                  var(--ds-rgb-primary-foreground)
               );
            }
            ...
            .ds-notification-container
               .ds-notification
               .ds-notification__close-wrapper {
               height: 21px;
               color: rgb(var(--ds-rgb-label-2));
               flex-grow: 0;
               flex-shrink: 0;
            ...
            .ds-notification-container
               .ds-notification
               .ds-notification__icon--warning {
               color: #f97316;
            }

            .ds-notification-container
               .ds-notification
               .ds-notification__icon--success {
               color: #22c55e;
            }

            .ds-notification-container
               .ds-notification
               .ds-notification__icon--error {
               color: rgb(var(--ds-rgb-error));
            }
            ...
            [data-ds-dark-theme]
               ...
               .ds-radio-button.ds-radio-button--active {
            ...
            .ds-radio-button-group.ds-radio-button-group--bordered1 {
               ...
               --radio-button-group-button-box-shadow: inset 0 0 0 1px
                  rgb(var(--ds-rgb-separator-strong));
               --radio-button-group-button-box-shadow-active: inset 0 0 0 1px
                  rgb(var(--ds-rgb-primary));
               --radio-button-group-button-box-shadow-active-focus: inset 0 0 0
                  1px rgb(var(--ds-rgb-primary));
               --radio-button-group-button-box-shadow-focus: inset 0 0 0 1px
                  rgb(var(--ds-rgb-separator-strong));
               --radio-button-group-button-color-active: rgb(
                  var(--ds-rgb-primary)
               );
               --radio-button-group-button-text-color-active: rgb(
                  var(--ds-rgb-primary-foreground)
               );
               --radio-button-group-button-outline-box-shadow-focus: 0 0 0 2px
                  rgb(var(--ds-rgb-primary));
            }
            ...
            .ds-radio-button-group.ds-radio-button-group--bordered2 {
               ...
               --radio-button-group-button-box-shadow: inset 0 0 0 1px
                  rgb(var(--ds-rgb-separator-strong));
               --radio-button-group-button-box-shadow-active: inset 0 0 0 2px
                  rgb(var(--ds-rgb-primary));
               --radio-button-group-button-box-shadow-active-focus:
                  inset 0 0 0 2px rgb(var(--ds-rgb-primary)),
                  0 0 0 1px rgb(var(--ds-rgb-primary));
               --radio-button-group-button-box-shadow-focus:
                  inset 0 0 0 1px rgba(var(--ds-rgb-primary) / 0.48),
                  0 0 0 1px rgba(var(--ds-rgb-primary) / 0.48);
            ...
            .ds-radio-button-group.ds-radio-button-group--bordered3 {
               ...
               --radio-button-group-button-box-shadow-focus: inset 0 0 0 1px
                  rgb(var(--ds-rgb-separator-strong));
               --radio-button-group-button-color-active: rgba(
                  var(--ds-rgb-primary) / 0.16
               );
               --radio-button-group-button-text-color-active: rgb(
                  var(--ds-rgb-primary)
               );
            ...
            .ds-radio-button-group.ds-radio-button-group--disabled
               .ds-radio-button,
            .ds-radio-button-group.ds-radio-button-group--disabled
               .ds-radio-button__input {
               cursor: not-allowed;
            }
            ...
            .ds-radio-button-group
               .ds-radio-button.ds-radio-button--focus:after {
               box-shadow: var(
                  --radio-button-group-button-outline-box-shadow-focus
               );
            }
            ...
            .ds-radio-button-group
               .ds-radio-button.ds-radio-button--active:focus-within {
               box-shadow: var(
                  --radio-button-group-button-box-shadow-active-focus
               );
            }
            ...
            .ds-textarea.ds-textarea--focused {
               background-color: var(
                  --ds-textarea-focus-color,
                  rgb(var(--ds-rgb-input-focus))
               );
               box-shadow: inset 0 0 0 2px
                  var(
                     --ds-textarea-focus-border-color,
                     rgb(var(--ds-rgb-primary))
                  );
            }
            ...
            [data-ds-dark-theme] .de80ba65 {
               ...
               box-shadow: 0 4px 16px rgba(51, 51, 51, 0.75);
            }
            ...
            .b4e4476b {
               ...
               --ds-md-zoom: 1.143;
               line-height: calc(
                  var(--ds-md-zoom) * var(--ds-line-height-m, 25px)
               );
            ...
            .cd190a50.e5931f90:hover {
               box-shadow:
                  0px 0px 0px 0.5px var(--dsr-input-border),
                  0px 4px 8px 0px rgba(144, 150, 174, 0.25);
            }
            ...
            .b2b9d30d {
               ...
               right: -5px;
               box-shadow:
                  0 1px 2px rgba(148, 147, 147, 0.25),
                  inset 0 0 0 0.5px #ededed;
            }
            ...
            .a418378a {
               ...
               box-shadow: 0 1px 2px rgba(148, 147, 147, 0.25);
            }
            ...
            [data-ds-dark-theme] .cd190a50.e5931f90:hover {
               box-shadow:
                  0px 0px 0px 0.5px var(--dsr-input-border),
                  0px 4px 8px 0px rgba(11, 11, 12, 0.25);
            }
            ...
            .f9edaa3c.b64fb9ae .eaaaba55 {
               background-image: linear-gradient(
                  to right,
                  rgba(var(--dsr-local-active-bg-rgb), 0),
                  var(--dsr-local-active-bg) 50%
               );
            }
            ...
            .ds-dropdown-menu {
               ...
               --ds-dropdown-menu-option-icon-size: calc(
                  var(--ds-font-size-m) + 4px
               );
            ...
            .ds-dropdown-menu-option.ds-dropdown-menu-option--error {
               ...
               --ds-dropdown-menu-option-color-hover: var(
                  --ds-dropdown-menu-option-error-color-hover,
                  rgba(var(--ds-rgb-error) / 0.06)
               );
            }
            ...
            .ds-segmented-button.ds-segmented-button--selected {
               ...
               background-color: var(
                  ...
                  rgb(var(--ds-rgb-segmented-button))
               );
               box-shadow:
            ...
            .a7f3a288 {
               width: 68px;
               transition:
                  left var(--ds-transition-duration-fast) var(--ds-ease-in-out),
                  opacity var(--ds-transition-duration-fast)
                     var(--ds-ease-in-out);
               position: absolute;
               top: 0;
               bottom: 0;
            ...
            .dc04ec1d {
               ...
               transition:
                  left var(--ds-transition-duration-fast) var(--ds-ease-in-out),
                  max-width var(--ds-transition-duration-fast)
                     var(--ds-ease-in-out);
               flex-shrink: 0;
               position: fixed;
               top: 0;
            ...
            .dd8acccf {
               ...
               background: linear-gradient(
                  to top,
                  var(--ds-background-1) 0%,
                  rgba(var(--ds-background-1-rgb), 0.5) 40%,
                  rgba(var(--ds-background-1-rgb), 0.15) 70%,
                  var(--ds-transparent) 100%
               );
               height: 16px;
               position: absolute;
               bottom: 0;
            ...
            .ds-alert.ds-alert--warning {
               --alert-color: rgba(var(--ds-rgb-warning) / 0.06);
            ...
            .ds-alert.ds-alert--warning:not(.ds-alert--bordered) {
               --alert-color: rgba(var(--ds-rgb-warning), 0.09);
            }

            .ds-alert.ds-alert--success {
               --alert-color: rgba(var(--ds-rgb-success-rgb) / 0.06);
            ...
            .ds-alert.ds-alert--success:not(.ds-alert--bordered) {
               --alert-color: rgba(var(--ds-rgb-success-rgb), 0.09);
            }

            .ds-alert.ds-alert--error {
               --alert-color: rgba(var(--ds-rgb-error) / 0.06);
            ...
            .ds-alert.ds-alert--error:not(.ds-alert--bordered) {
               --alert-color: rgba(var(--ds-rgb-error), 0.09);
            }

            .ds-alert.ds-alert--info {
               --alert-color: rgba(var(--ds-rgb-info) / 0.06);
            ...
            .ds-theme {
               ...
               --ds-font-family-code:
                  Menlo, 'Roboto Mono', 'Courier New', Courier, monospace,
                  'Inter', sans-serif;
            ...
            .ds-markdown {
               --ds-md-zoom: 1.143;
               --ds-md-font-size: calc(
                  var(--ds-md-zoom) * var(--ds-font-size-m)
               );
               --ds-md-line-height: calc(
                  var(--ds-md-zoom) * var(--ds-line-height-m)
               );
            ...
            .ds-markdown h6 {
               ...
               font-size: var(--ds-md-font-size);
               line-height: var(--ds-md-line-height);
               margin: calc(var(--ds-md-zoom) * 16px) 0
                  calc(var(--ds-md-zoom) * 12px) 0;
            }
            ...
            .ds-markdown th {
               color: rgb(var(--ds-rgb-label-1));
               padding: calc(var(--ds-md-zoom) * 6px)
                  calc(var(--ds-md-zoom) * 12px);
            ...
            .md-code-block {
               --ds-md-code-block-font-size: calc(
                  var(--ds-md-zoom) * var(--ds-font-size-xsp)
               );
            ...
            .ds-verify-code-form-item
               .ds-verify-code-form-item__verify-code-input {
               flex: 1;
            }

            .ds-verify-code-form-item
               .ds-verify-code-form-item__verify-code-button {
               flex: 0 0;
            }
            ...
            [data-ds-dark-theme] {
               --ds-toast-custom-box-shadow: 0px 4px 10.2px 0px
                  rgba(0, 0, 0, 0.25);
   ...
   <body
      class="apple en_US dark"
      data-ds-dark-theme="dark"
      style="--app-height: 878px"
   >
      <div id="root">
         <div class="cb86951c">
            <div class="c3ecdb44">
               <div class="f2eea526">
                  <div class="a5cd95be">
                     <div class="b83ee326">
                        <div class="f6004764">
                           <div class="f72b0bab">
                              <div class="dad65929" id="client"></div>
                              <div class="cbcaa82c">
                                 <div class="aaff8b8f">
                                    <div class="cefa5c26">
                                       <div class="dd442025 b699646e">
                                          ...
                                          <div class="ec4f5d61">
                                             <div
                                                role="button"
                                                class="ds-button ds-button--primary ds-button--filled ds-button--rect ds-button--m d9f56c96"
                                                style="
                                                   --ds-button-color: rgba(
                                                      77,
                                                      107,
                                                      254,
                                                      0.4
                                                   ...
                                                   --button-border-color: rgba(
                                                      0,
                                                      122,
                                                      255,
                                                      0.15
                                                   );
                                                   --ds-button-hover-color: rgba(
                                                      77,
                                                      107,
                                                      254,
                                                      0.2
         ...
         document.addEventListener('DOMContentLoaded', function () {
            ...
            function updateButtonState() {
               if (textarea.value.trim().length > 0) {
                  ...
                  button.disabled = false; // Ensure interactivity

                  // ❌ Change class to "f6d670" (invalid state)
                  button.className = 'f6d670';
               } else {
                  button.setAttribute('aria-disabled', 'true');
                  button.setAttribute('disabled', 'true');
                  button.classList.add('disabled');
                  button.disabled = true; // Ensure disabled state

                  // ✅ Change class to "f6d670 bcc55ca1" (valid state)
                  button.className = 'f6d670 bcc55ca1';
               }

               console.log('Button class updated:', button.className); // Debugging log
            }

            textarea.addEventListener('input', updateButtonState);
            // On click, if the button is valid (i.e. not disabled), add a paragraph to the body.
            button.addEventListener('click', function () {
               if (!button.disabled) {
                  ...
                  if (window.wx_msg && window.wx_msg.postMessage) {
                     ...
                     console.log('wx_msg handler is not available.');
                  }
               }
            });
